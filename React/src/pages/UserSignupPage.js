...
const UserSignupPage = (props) => {
    ...
    const onClickSignup = async event => {
        ...
        const { userID, username, password } = form;
    ...
    const { userID: userIDError, username: usernameError, password: passwordError } = errors;
    ...
    return (
        <div className="container">
            <form>
                ...
                <Input name="userID" label={t("ID")} error={userIDError} onChange={onChange} />
